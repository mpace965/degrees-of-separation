...
var SteamResultView = React.createClass({
  ...
  getNodeNames: function() {
    return this.props.activeViewState.graph.nodeValues.map(function(steamGame) {
      return steamGame.name;
    });
  },
...
module.exports = SteamResultView;
